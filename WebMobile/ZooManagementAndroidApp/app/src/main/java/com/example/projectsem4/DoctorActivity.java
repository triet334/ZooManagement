...
public class DoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetHealthtracking.setOnClickListener(v -> {
            Intent intent = new Intent(DoctorActivity.this, DoctorHealthtrackingActivity.class);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        Intent intent;
        switch (id) {
            case R.id.btnUpdate: intent = new Intent(DoctorActivity.this,UpdateActivity.class);
                startActivity(intent);
                break;
            case R.id.btnLogOut: intent = new Intent(DoctorActivity.this,LogoutActivity.class);
                startActivity(intent);
                break;
        }
    ...
    private void findByCode(String ecode) {
        ...
        call.enqueue(new Callback<Employee>() {
            ...
            public void onFailure(Call<Employee> call, Throwable t) {
                ...
                Toast.makeText(DoctorActivity.this, "Bla  Bla!!!!!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}